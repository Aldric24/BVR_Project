...
public class GeneralBasic : MonoBehaviour {
	...
	void Start () {
		...
		LeanTween.moveX( avatarScale, avatarScale.transform.position.x + 5f, 5f).setEase(LeanTweenType.easeOutBounce); // Simultaneously heading many different tweens on the same object 
